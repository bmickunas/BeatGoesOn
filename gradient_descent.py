...
class GradientDescent(object):
    def __init__(self):
        ...
        self.N = 1 # number of song_pairs seen; used form the learning_rate
    ...
    def _calc_gradient(self, learning_rate, loss, input):
        delta_weight = {}
        for dim in dim_full_set:
            delta_weight[dim] = learning_rate*loss*input[dim]
        return delta_weight
    ...
    def learn(self, song_pairs):
        ...
        for pair in song_pairs:            
            ...
            del_w = self._calc_gradient(self.learning_rate, abs(loss), pair[0])
